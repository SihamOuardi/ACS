 ...
 * 
 */
@WebServlet("/ChallengeFlow")
public class ChallengeFlow extends HttpServlet  {
		...
		protected void doPost(HttpServletRequest request,
			...
			System.out.println("ChallengeFlow start  do post  " );
		...
		public static void setHttpResponse(HttpServletResponse httpResponse) {
			ChallengeFlow.httpResponse = httpResponse;
		}
